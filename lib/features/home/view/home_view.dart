...
import 'package:fyp2_clean_architecture/features/home/view/tabpages/notes/note_view.dart';
...
class _HomeViewState extends ConsumerState<HomeView> {
  ...
  Widget build(BuildContext context) {
    ...
    final profilePictureUrl = ref.watch(currentUserProvider).value!.profilePictureUrl;
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: Padding(
              ...
              child: CircleAvatar(
                foregroundImage: NetworkImage(profilePictureUrl.replaceAll('localhost', '10.0.2.2')),
              ),
            ),
            title: Padding(
              ...
              Padding(
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    // Navigator.pushReplacementNamed(context, SplashView.routeName).then((_) async {
                    // });
                  },
                ),
              ),
